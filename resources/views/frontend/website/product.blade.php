                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                        <div class="single-product">
                                            <div class="product-img">
                                                <a href="{{ route('website.detail',$product->id )}}">
                                                    <img class="default-img" src="{{$product->product_image}}" alt="#" style='width:400px; height: 300px'>
                                                </a>
                                            ...
                                            <div class="product-content">
                                                <h3><a href="'website.detail">{{$product->product_name}}</a></h3>
                                                <div class="product-price">
                                                    <span style="color: red">{{ number_format($product->product_price).' '.'VNĐ'}}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
